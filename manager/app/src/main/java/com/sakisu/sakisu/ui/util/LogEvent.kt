...
import com.sakisu.sakisu.ui.screen.main.getManagerVersion
import java.io.File
...
fun getBugreportFile(context: Context): File {
    ...
    PrintWriter(FileWriter(buildInfo)).use { pw ->
        ...
        pw.println("SakiSU: $ksuKernelFull")
    ...
    val targetFile = File(context.cacheDir, "SakiSU_bugreport_${current}.tar.gz")
